    ...
    <div id="content-body" class="text-left">
      ...
      <div class="row">
        ...
        <div class="col-2 form-group">
          ...
          <input type="text" name="mediaType1" id="input_refName1" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refCompany1">
            COMPANY
          </label><br>
          <input type="text" name="refCompany" id="input_refCompany1" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refJob1">
            JOB TITLE
          </label><br>
          <input type="text" name="refJob" id="input_refJob1" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refContact1">
            CONTACT NUMBER
          </label><br>
          <input type="text" name="refContact" id="input_refContact1" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refEmail1">
            EMAIL
          </label><br>
          <input type="text" name="refEmail" id="input_refEmail1" class="form-control">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-2 form-group">
          ...
          <input type="text" name="mediaType1" id="input_refName2" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refCompany2">
            COMPANY
          </label><br>
          <input type="text" name="refCompany" id="input_refCompany2" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refJob2">
            JOB TITLE
          </label><br>
          <input type="text" name="refJob" id="input_refJob2" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refContact2">
            CONTACT NUMBER
          </label><br>
          <input type="text" name="refContact" id="input_refContact2" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refEmail2">
            EMAIL
          </label><br>
          <input type="text" name="refEmail" id="input_refEmail2" class="form-control">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-2 form-group">
          ...
          <input type="text" name="mediaType1" id="input_refName3" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refCompany3">
            COMPANY
          </label><br>
          <input type="text" name="refCompany" id="input_refCompany3" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refJob3">
            JOB TITLE
          </label><br>
          <input type="text" name="refJob" id="input_refJob3" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refContact3">
            CONTACT NUMBER
          </label><br>
          <input type="text" name="refContact" id="input_refContact3" class="form-control">
        </div>
        <div class="col-2 form-group">
          <label id="label_input_refEmail3">
            EMAIL
          </label><br>
          <input type="text" name="refEmail" id="input_refEmail3" class="form-control">
        </div>
      </div>
      <br><br>
