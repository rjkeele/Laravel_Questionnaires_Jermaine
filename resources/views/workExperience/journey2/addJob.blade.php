  ...
  <div class="container text-center">
    ...
    <div id="content-body" class="text-center">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-8 text-left">
          <input type="text" id="input_jobStartDate" placeholder="{{ Session::get('journey2StartDate') }}"
                 class="input-lg form-control-lg" value="{{ Session::get('journey2StartDate') }}">
        </div>
      </div>
      <div class="form-group row">
        <div class="col-md-3 text-right">
        ...
        <div class="col-md-8 text-left">
          <input type="text" id="input_jobEndDate" placeholder="{{ Session::get('journey2EndDate') }}"
                 class="input-lg form-control-lg" value="{{ Session::get('journey2EndDate') }}">
        </div>
      </div>
      <div class="form-group row">
        <div class="col-md-3 text-right">
