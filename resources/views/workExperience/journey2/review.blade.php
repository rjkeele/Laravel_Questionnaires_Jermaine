            ...
            <div class="div_form_group form-group row">
              ...
              <div class="col-md-9 text-left">
                <input type="text" id="input_jobStartDate" placeholder="{{ $data['companies'][0] -> journey1StartJob }}"
                       class=" form-control form-control-lg" value="{{ $data['companies'][0] -> journey1StartJob }}"
                       disabled>
              </div>
            </div>
            <div class="div_form_group form-group row">
              ...
              <div class="col-md-9 text-left">
                <input type="text" id="input_jobEndDate" placeholder="present"
                       class=" form-control form-control-lg" value="present" disabled>
              </div>
            </div>
            <div class="div_form_group form-group row">
              <div class="col-md-3 text-right">
