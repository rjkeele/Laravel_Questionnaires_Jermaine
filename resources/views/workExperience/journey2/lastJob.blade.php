  ...
  <div class="container text-center" style="width: 80%;min-width: 250px">
    ...
    <div id="content-body" class="text-center">
      ...
      <div class="text-center" id="div_schoolName_continue">
        <button id="btn_lastJob_continue" class="btn btn-lg btn-success" type="button"> CONTINUE </button>
      </div>
    </div>
  </div>
@endsection
...
@section('js')
  <script>
      $(document).ready(function () {
          $('#btn_lastJob_continue').click(function () {
              ...
              $.ajax({
                  ...
                  url: '/temp_info_save/workExperience/journey2/lastJob',
                  data: {
                  ...
                  success: function (result) {
                      if (result === 'success') {
                          window.location.href = '/workExperience/journey2/company';
                      }
                  }
              });
          });
