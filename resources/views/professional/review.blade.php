...
@section('content')
  <div class="container text-center">
    <div id="content-header">
      Your Professional Skills Review
    </div>
        ...
        <div class="col-8 row">
          <div class="col-6 form-group">
            ...
            <input list="skills" name="skillName1" id="skillName1" class="form-control"
                   value="{{ $data['professional'][0]->professionalSkillName1 }}" required>
            <datalist id="skills">
            ...
            <input list="skills" name="skillName2" id="skillName2"
                   value="{{ $data['professional'][0]->professionalSkillName2 }}" class="form-control" required>
            <input list="skills" name="skillName3" id="skillName3"
                   value="{{ $data['professional'][0]->professionalSkillName3 }}" class="form-control" required>
            <input list="skills" name="skillName4" id="skillName4"
                   value="{{ $data['professional'][0]->professionalSkillName4 }}" class="form-control">
            <input list="skills" name="skillName5" id="skillName5"
                   value="{{ $data['professional'][0]->professionalSkillName5 }}" class="form-control">
          </div>
          <div class="col-6 form-group">
            ...
            <select list="ratings" name="skillRating1" id="skillRating1" class="form-control"
                    required>
              @for($i = 1; $i < 6; $i++)
                @if($i == (int)$data['professional'][0]->professionalSkillRating1)
            ...
            <select list="ratings" name="skillRating2" id="skillRating2" class="form-control"
                    required>
              @for($i = 1; $i < 6; $i++)
                @if($i == (int)$data['professional'][0]->professionalSkillRating2)
                  <option selected="selected" value="{{ $i }}">{{ $i }}</option>
                @else
                  <option value="{{ $i }}">{{ $i }}</option>
                @endif
            ...
            <select list="ratings" name="skillRating3" id="skillRating3" class="form-control"
                    required>
              @for($i = 1; $i < 6; $i++)
                @if($i == (int)$data['professional'][0]->professionalSkillRating3)
                  <option selected="selected" value="{{ $i }}">{{ $i }}</option>
                @else
                  <option value="{{ $i }}">{{ $i }}</option>
                @endif
            ...
            <select list="ratings" name="skillRating4" id="skillRating4" class="form-control"
                    required>
              @for($i = 1; $i < 6; $i++)
                @if($i == (int)$data['professional'][0]->professionalSkillRating4)
                  <option selected="selected" value="{{ $i }}">{{ $i }}</option>
                @else
                  <option value="{{ $i }}">{{ $i }}</option>
                @endif
            ...
            <select list="ratings" name="skillRating5" id="skillRating5" class="form-control"
                    required>
              @for($i = 1; $i < 6; $i++)
                @if($i == (int)$data['professional'][0]->professionalSkillRating5)
                  <option selected="selected" value="{{ $i }}">{{ $i }}</option>
                @else
                  <option value="{{ $i }}">{{ $i }}</option>
                @endif
